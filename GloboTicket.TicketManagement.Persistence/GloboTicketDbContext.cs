    ...
    public class GloboTicketDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 65,
                Artist = "John Egbert",
                Date = DateTime.SpecifyKind(new DateTime(2025, 6, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 85,
                Artist = "DJ 'The Mike'",
                Date = DateTime.SpecifyKind(new DateTime(2025, 4, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 400,
                Artist = "Many",
                Date = DateTime.SpecifyKind(new DateTime(2025, 10, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 135,
                Artist = "Nick Sailor",
                Date = DateTime.SpecifyKind(new DateTime(2025, 8, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 400,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 1, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 135,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 2, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 85,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 3, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 245,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 4, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 142,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 5, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 40,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 6, 1), DateTimeKind.Utc),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 116,
                OrderPaid = true,
                OrderPlaced = DateTime.SpecifyKind(new DateTime(2025, 7, 1), DateTimeKind.Utc),
                UserId = Guid.Parse("{7AEB2C01-FE8E-4B84-A5BA-330BDF950F5C}")
            });
        }
